...
class Translation(object):
 ...
 Hi Chris , I'm A Simple File Renamer+File To Video Converter Bot With Permanent Thumbnail support!💯 


Bot Made By: [CHRIS CARLO 👨‍🎤](https://t.me/Chris_Carlo) 
...
Type /help for more details."""
    ...
    CUSTOM_CAPTION_UL_FILE = "©️ [CHRIS CARLO](https://t.me/Chris_Carlo)"
    NO_CUSTOM_THUMB_NAIL_FOUND = "No Custom ThumbNail found."
    USER_ADDED_TO_DB = "User <a href='tg://user?id={}'>{}</a> added to {} till {}."
    HELP_USER = """Hai <b><i>{}</i></b>, 

I am Renamer bot ✍ by <a href='https://t.me/Chris_Carlo'>My Father 👨‍🏫</a>
...
<b>Thanks to <i><a href="https://t.me/Darklester">BLACK PSYCHO 🤵</a></i> for his Datbase.</b>

--------

Support Group : @CCREQUESTGROUP"""
...
**💻 Source Code:**[Press Here](https://t.me/Nokkiirunnoippokittum)"""
